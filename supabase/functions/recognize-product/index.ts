...
🔍 КРИТЕРИИ ТОЧНОГО СОВПАДЕНИЯ (100% на КАЖДЫЙ пункт + РАЗНОВИДНОСТИ!):
1. БРЕНД - точное название производителя
2. ПОЛНОЕ НАЗВАНИЕ товара со ВСЕМИ деталями
3. ⚡ РАЗНОВИДНОСТЬ/ВАРИАЦИЯ - КРИТИЧНО:
...
4. ВЕС/ОБЪЕМ - ТОЧНАЯ цифра (50г ≠ 75г ≠ 100г, 200мл ≠ 250мл)
...
2. Прочитай ВЕСЬ текст на упаковке:
   ...
   - Точный вес/объем
3. Сравни с базой КАЖДУЮ деталь построчно, используя ПОЛНУЮ ИНФОРМАЦИЮ (поставщик, единицы)
4. ВСЕ 8 критериев совпали на 100%? → верни barcode
5. ХОТЬ ЧТО-ТО отличается (особенно РАЗНОВИДНОСТЬ)? → barcode = "", заполни name + category

🚨 ПРИМЕРЫ РАЗНЫХ ТОВАРОВ ПО РАЗНОВИДНОСТЯМ (НЕ ПУТАЙ!):
...
⚠️ ЖЕЛЕЗНОЕ ПРАВИЛО: 
- Если РАЗНОВИДНОСТЬ/ВАРИАЦИЯ не совпадает на 100% → barcode = ""
