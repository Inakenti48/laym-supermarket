...
3. ОСОБЕННОСТИ состава ("с молоком", "без молока", "с пантенолом", "с пребиотиком" и т.д.)
4. ВЕС/ОБЪЕМ - ТОЧНАЯ цифра (50г ≠ 75г ≠ 100г)
5. ЦВЕТ упаковки (желтый ≠ синий ≠ розовый)
...
2. Прочитай ВЕСЬ текст на упаковке:
   ...
   - Точный вес/объем
3. Сравни с базой КАЖДУЮ деталь построчно
4. ВСЕ 6 критериев совпали на 100%? → верни barcode
5. ХОТЬ ЧТО-ТО отличается? → barcode = "", заполни name + category

🚨 ЭТО РАЗНЫЕ ТОВАРЫ (НЕ ПУТАЙ!):
Каши:
- "Bebi рисовая С МОЛОКОМ" ≠ "Bebi рисовая БЕЗ МОЛОКА"
- "Bebi с пребиотиком" ≠ "Bebi без пребиотика"
- "Bebi 200г" ≠ "Bebi 250г"

Кремы/Косметика:
- "Крем с пантенолом" ≠ "Крем с ромашкой" ≠ "Крем увлажняющий"
- "Крем 50мл" ≠ "Крем 75мл"
- Разные упаковки (тюбик/баночка) = разные товары

⚠️ ПРАВИЛО: Если не уверен на 100% - barcode = ""!`;
    } else {
