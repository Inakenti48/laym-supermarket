...
ИНСТРУКЦИИ:
1. Внимательно изучи упаковку на фото
2. Прочитай ВСЁ: название бренда, тип продукта, вкус, вариант, размер, особенности
3. Составь ПОЛНОЕ название включая все детали (например: "Coca-Cola Zero 0.5л", "Snickers шоколадный батончик с арахисом 50г")
4. Определи категорию товара (напитки, закуски, молочное, хлеб, мясо, и т.д.)
5. Сравни с базой данных - если находишь ТОЧНОЕ совпадение, верни его barcode
6. Если штрихкод виден на фото - используй его для поиска в базе
7. Если товара нет в базе - оставь barcode пустым, но заполни name и category
